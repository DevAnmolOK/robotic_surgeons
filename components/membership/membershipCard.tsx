  ...
  return (
    <>
      <div
        ...
        className={`group flex md:h-[29.5rem] max-h-[34.5rem] md:max-w-[23rem] max-w-[28rem] w-full hover:h-[32.813rem] hover:max-w-[23rem] border border-[#E3E3E3] hover:bg-theme hover:text-white text-black flex-col p-[2.25rem] rounded-[2.375rem] transition-all duration-300`}
      >
        <div>
