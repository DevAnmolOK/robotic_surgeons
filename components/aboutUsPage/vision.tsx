...
export default async function Vision() {
  const purposeRes = await fetch(
    `${process.env.NEXT_PUBLIC_API_URL}/block/aboutmissionvision`
  );
  ...
  return (
    <>
      <div className="h-auto w-full flex items-center justify-center  py-[5rem] ">
        <div className=" sm:max-w-[75vw] max-w-[85vw] w-full  lg:h-[18rem] text-black flex flex-col  lg:flex-row gap-[3.5rem] ">
